export const DEFAULT_CONTACT_CONTENT = {
  ...
  social: {
    ...
    linkedin: 'https://linkedin.com/company/khybermotors',
    youtube: 'https://youtube.com/khybermotors',
  },
  ...
  stats: [
    { label: '3S Service Facility', value: '15,000+ Sq. Ft.' },
    { label: 'Factory Warranty', value: '3 Yrs / 100K KM' },
    { label: 'Genuine Spare Parts', value: '100% In-Stock' },
    { label: 'Happy Fleet Clients', value: '500+ KP Businesses' },
  ],

  features: [
    {
      title: 'Authorized 3S Facility',
      description: 'Complete Sales, Aftersales Service, and Genuine Spare Parts under one high-tech roof in Peshawar.',
      icon: 'ShieldCheck',
    },
    {
      title: 'Factory-Trained Technicians',
      description: 'Certified engineers trained on state-of-the-art diagnostic machinery and JAC technical protocols.',
      icon: 'Wrench',
    },
    {
      title: 'Heavy-Duty Commercial Lineup',
      description: 'Heavy & light commercial vehicles engineered specifically for KP mountain terrain and long-haul transport.',
      icon: 'Truck',
    },
    {
      title: 'Dedicated Corporate Fleet Support',
      description: 'Custom financing, priority maintenance scheduling, and dedicated key account managers for logistics fleets.',
      icon: 'Building2',
    },
  ],
};

export const DEALERSHIP_INFO = DEFAULT_CONTACT_CONTENT;
